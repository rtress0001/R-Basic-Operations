...
```{r}
names <- c("John","Jim","Jemy","Jake","Jan")
names
...
```{r}
# Get the second row of all of the matrices notice the rotation in the display
my_array[2,,]
...
```{r}
#Levels are useful for making your own order for sorting
my_factor <- factor(c("Blue","Green","Brown","Blue","Green","Brown","Grey"),
...
```{r}
frist_vector <- c(1,2,3,4,5,6,7,8,9)
second_vector <- c(9,8,7,6,5,4,3,2,1)

my_array <- array(
  #data
  c(frist_vector,second_vector),
  #Dimensions
  dim <- c(3,3,2),
  #Row/Column Names
  dimnames <- list(c("Row 1", "Row 2","Row 3"),
