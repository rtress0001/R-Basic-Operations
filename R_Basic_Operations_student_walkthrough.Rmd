...
```{r}
substr("How much wood would could a woodchuck chuck", start <- 5, stop <-13)
...
```{r}
sub("much","little", "how much wood would could a woodchuck chuck")
```
...
1.  Create two strings with your first and last name, respectively. Then concatenate them, and print the new value as "My name is \<your newly created concatenated variable will go here\>"
    ...
    first_name <- "Ryan"
    last_name <- "Tressman"
    greeting_full_name <- paste("My name is", first_name, last_name)
    greeting_full_name
